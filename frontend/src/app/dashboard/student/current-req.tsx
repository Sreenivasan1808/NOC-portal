    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2">
          You don&apos;t have any requests currently in process.
        </p>
      </div>
    );
  }
    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Track the progress of your current no-due request
        </p>
      </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-between">
                <p className="text-sm text-muted-foreground">
                  {faStatus === "Pending" &&
                    `Waiting for ${
                      me?.facultyAdvisorName || "your faculty advisor"
                ...
                <Link
                  href={
                    ...
                    encodeURIComponent(
                      (currentReq.active[0] as INoDueReq & { _id: string })?._id
                    )
                  }
                  className="flex items-center gap-1 text-foreground hover:text-foreground-muted transition-colors flex-shrink-0"
                >
